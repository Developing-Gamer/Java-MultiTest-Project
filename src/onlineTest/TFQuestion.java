...
public class TFQuestion implements QuestionInt, Serializable {
	...
	public String getInfo(int examId, int questionNumber) {
		...
		answer += "Correct Answer: "
				+ infoList.get(2).toString().substring(0, 1).toUpperCase()
				+ infoList.get(2).toString().substring(1) + "\n";
	...
	public void answerTrueFalseQuestion(String studentName, int examId,
		...
		if (queId.containsKey(examId)
			...
			if (infoList != null && (Boolean) infoList.get(2) == answer) {
