...
public interface Manager {
	...
	/**
	 * Adds the specified student to the database. Names are specified in the
	...
	/**
	 * Generates a grading report for the specified exam. The report will
	 * include the following information for each exam question:<br />
	...
	/**
	 * Sets the cutoffs for letter grades. For example, a typical curve we will
	 * have new String[]{"A","B","C","D","F"}, new double[] {90,80,70,60,0}.
	 * Anyone with a 90 or above gets an A, anyone with an 80 or above gets a B,
	 * etc. Notice we can have different letter grades and cutoffs (not just the
	 * typical curve).
	 * 
	 * @param letterGrades
	 * @param cutoffs
	...
	/**
	 * Computes a numeric grade (value between 0 and a 100) for the student
	 * taking into consideration all the exams. All exams have the same weight.
	 * 
	 * @param studentName
	 * @return grade
	 */
	...
	/**
	 * Returns the maximum score (among all the students) for the specified
	 * exam.
	 * 
	 * @param examId
	 * @return maximum
	...
	/**
	 * Returns the minimum score (among all the students) for the specified
	 * exam.
	 * 
	 * @param examId
	 * @return minimum
